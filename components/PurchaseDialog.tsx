...
export default function PurchaseDialog({ kc, open, retailer: initialRetailer, onClose, onSaved }: Props) {
  ...
  return (
    <>
      ...
      {/* Bottom sheet */}
      <div className="fixed bottom-0 left-0 right-0 z-50 mx-auto max-w-md rounded-t-2xl border-t border-gold-500/20 bg-navy-900 px-5 pb-10 pt-5 shadow-2xl">
        ...
        {insight ? (
          ...
          <>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                onClick={handleSave}
                className="flex flex-[2] items-center justify-center gap-2 rounded-full bg-gold-500 py-3 text-sm font-semibold text-navy-950 active:bg-gold-400"
              >
                <ShoppingBag size={15} />
                I Bought This
              </button>
